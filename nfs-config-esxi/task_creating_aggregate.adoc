...
.Étapes
. Saisissez l'URL `+https://IP-address-of-cluster-management-LIF+` dans un navigateur web, connectez-vous à l'aide des informations d'identification de l'administrateur du cluster.
...
+
image::../media/aggregate_creation_nfs_esxi.gif[Création d'un écran d'agrégat dans System Manager]
